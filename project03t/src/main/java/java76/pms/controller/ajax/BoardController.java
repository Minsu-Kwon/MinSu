...
// 컨트롤러의 ()이 비어있다면 boardController.java의 이름을 소문자로 변경한 후 만든 게 BoardController와 동일하기 때문에 컨트롤러의 이름을 변경해야한다.
...
public class BoardController { 
  ...
  @RequestMapping("list")
  public Object list( // return String -> Object
  ...
  public AjaxResult delete(
      int no, String password) throws Exception {
