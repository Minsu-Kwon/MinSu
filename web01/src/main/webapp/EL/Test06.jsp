...
<%-- 객체(맵) 안에 저장된 객체의 프로퍼티 값 꺼내기
=> 문법
${보관소명.객체이름.프로퍼티이름.프로퍼티이름-getter}
${객체이름.프로퍼티이름.프로퍼티이름}
--%>
...
<%-- OGNL 표기법 
	=> Open Graph Navigation Language (계방적인 구조의 그래프 탐색 언어)
	=> 그래프? 계층 구조로 이루어진 값을 그래프라 표현한다.
	=> 그래프 네비게이션? 계층 구조를 따라가며 원하는 값을 찾는 것.
	=> 즉 OVNL은 계층 구조로 이루어진 저장소에서 객체를 찾을 때 사용하는 표기법
